...
void FSGGameplayTagCountContainer::Notify_StackCountChange(const FGameplayTag& Tag)
{
...
FSGOnGameplayEffectTagCountChanged& FSGGameplayTagCountContainer::RegisterGameplayTagEvent(const FGameplayTag& Tag, EGameplayTagEventType::Type EventType)
{
...
void FSGGameplayTagCountContainer::Reset()
{
...
bool FSGGameplayTagCountContainer::UpdateTagMap_Internal(const FGameplayTag& Tag, int32 CountDelta)
{
	...
	for (auto CompleteTagIt = TagAndParentsContainer.CreateConstIterator(); CompleteTagIt; ++CompleteTagIt)
	{
		...
		if (DelegateInfo)
		{
			...
			FSGOnGameplayEffectTagCountChanged OnNewOrRemoveLocalCopy = DelegateInfo->OnNewOrRemove;
